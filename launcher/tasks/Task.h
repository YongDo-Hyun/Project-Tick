...
struct TaskStepProgress
{
	...
	bool isDone() const
	{
		return (state == TaskStepState::Failed) || (state == TaskStepState::Succeeded);
	}
...
class Task : public QObject, public QRunnable
{
  ...
  public:
	 ...
	 */
	virtual auto isMultiStep() const -> bool
	{
		return false;
	}
	...
	virtual auto getStepProgress() const -> TaskStepProgressList
	{
		return {};
	}

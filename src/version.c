...
/*
 * uVim originated from Stevie version 3.6 (Fish disk 217) by GRWalter (Fred)
 ...
 * See the official uVim patches for the diff format: It must use a context of
...
/*
 * Give an introductory message about uVim.
 * Only used when starting uVim on an empty file, without a file name.
    ...
    int		colon)		/* TRUE for ":intro" */
{
    ...
    static char	*(lines[]) =
    {
	N_("uVim - Micro Vi IMproved"),
	"",
	N_("version "),
	N_("Project Tick and uVim contributors"),
#ifdef MODIFIED_BY
	" ",
#endif
	N_("uVim is open source and freely distributable"),
	"",
	"",
	...
	N_("type  :set nocp<Enter>        for uVim defaults"),

...
EX(CMD_ascii,		"ascii",	do_ascii,
			...
			ADDR_LINES),
EX(CMD_autocmd,		"autocmd",	ex_ni,
			BANG|EXTRA|NOTRLCOM|USECTRLV|CMDWIN,
			ADDR_LINES),
EX(CMD_augroup,		"augroup",	ex_ni,
...
EX(CMD_caddfile,	"caddfile",	ex_cfile,
			TRLBAR|FILE1,
			ADDR_LINES),
EX(CMD_call,		"call",		ex_ni,
			RANGE|NEEDARG|EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_catch,		"catch",	ex_ni,
			EXTRA|SBOXOK|CMDWIN,
			ADDR_LINES),
...
EX(CMD_delmarks,	"delmarks",	ex_delmarks,
			BANG|EXTRA|TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_debug,		"debug",	ex_ni,
			NEEDARG|EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_debuggreedy,	"debuggreedy",	ex_ni,
			RANGE|NOTADR|ZEROR|TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_delcommand,	"delcommand",	ex_delcommand,
			NEEDARG|WORD1|TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_delfunction,	"delfunction",	ex_ni,
...
EX(CMD_dlist,		"dlist",	ex_findpat,
			...
			ADDR_LINES),
EX(CMD_doautocmd,	"doautocmd",	ex_ni,
			EXTRA|TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_doautoall,	"doautoall",	ex_ni,
			EXTRA|TRLBAR|CMDWIN,
			ADDR_LINES),
...
EX(CMD_earlier,		"earlier",	ex_later,
			...
			ADDR_LINES),
EX(CMD_echo,		"echo",		ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_echoerr,		"echoerr",	ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_echohl,		"echohl",	ex_ni,
			EXTRA|TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_echomsg,		"echomsg",	ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_echon,		"echon",	ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_else,		"else",		ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_elseif,		"elseif",	ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_emenu,		"emenu",	ex_emenu,
			NEEDARG|EXTRA|TRLBAR|NOTRLCOM|RANGE|NOTADR|CMDWIN,
			ADDR_LINES),
EX(CMD_endif,		"endif",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_endfunction,	"endfunction",	ex_ni,
			TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_endfor,		"endfor",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_endtry,		"endtry",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_endwhile,	"endwhile",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
...
EX(CMD_find,		"find",		ex_find,
			...
			ADDR_LINES),
EX(CMD_finally,		"finally",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_finish,		"finish",	ex_ni,
			TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
...
EX(CMD_foldopen,	"foldopen",	ex_foldopen,
			RANGE|BANG|WHOLEFOLD|TRLBAR|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_for,		"for",		ex_ni,
			EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
			ADDR_LINES),
EX(CMD_function,	"function",	ex_ni,
			EXTRA|BANG|CMDWIN,
			ADDR_LINES),
...
EX(CMD_sbrewind,	"sbrewind",	ex_brewind,
			EDITCMD|TRLBAR,
			ADDR_LINES),
EX(CMD_scriptnames,	"scriptnames",	ex_ni,
			TRLBAR|CMDWIN,
			ADDR_LINES),
EX(CMD_scriptencoding,	"scriptencoding", ex_ni,
			WORD1|TRLBAR|CMDWIN,
			ADDR_LINES),

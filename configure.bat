...
echo WINDOWS_TOOLCHAIN := !TOOLCHAIN!
echo.
...
echo.
if "!TOOLCHAIN!"=="msvc" (
echo For MSVC, make sure you have GNU Make installed or use MinGW's make.
echo Example: choco install make  (with Chocolatey)

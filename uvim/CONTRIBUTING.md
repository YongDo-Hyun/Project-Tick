...
Information about the maillist can be found [on the uVim website].

[on the uVim website]: http://www.vim.org/maillist.php#vim-dev
...
We use GitHub issues, but that is not a requirement.  Writing to the uVim
maillist is also fine.

Please use the GitHub issues only for actual issues. If you are not 100% sure
that your problem is a uVim issue, please first discuss this on the uVim user

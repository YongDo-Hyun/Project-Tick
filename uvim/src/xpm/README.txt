This is XPM library compiled for Windows which is intended for use with uVim
'signs' feature.

Libraries in x86 directory were compiled with MSVC6 and MinGW. Proposed
commands to compile uVim are:
...
To test, open some file in uVim and execute commands below:

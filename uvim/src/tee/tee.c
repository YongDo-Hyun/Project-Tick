 ...
 * and dirty implementation to distribute with uVim, to make one of the
 * most useful features of uVim possible on OS/2: quickfix.
 *
...
\n\
This version supplied with uVim 4.2 to make ':make' possible.\n\

...
do_viminfo(FILE *fp_in, FILE *fp_out, int flags)
{
	...
	if (flags & VIF_WANT_INFO)
	{
		 ...
		 * this uVim is using.  They are merged when writing. */
    ...
    {
	/* Write the info: */
	fprintf(fp_out, _("# This viminfo file was generated by uVim %s.\n"),
							  VIM_VERSION_MEDIUM);
...
read_viminfo_barline(vir_T *virp, int got_encoding, int force, int writing)
{
	...
	switch (bartype)
	{
		 ...
		 * If it comes later it was copied by a uVim version that

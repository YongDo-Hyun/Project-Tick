...
hangul_automata2(char_u *buf, int_u *c)
{
	...
	case 0: /* ���� (consonant) */
	    ...
	    {
		t2 = lcon(t);
		if (!t2)    /* ��ħ���� ���������ʴ� (cannot use it as a prop) */
		{
		    hangul_input_clear();
		    last_ll = last_l = -1;
		    f = fcon(t);
...
hangul_automata3(char_u *buf, int_u *c)
{
	...
	*c -= '!';
	...
	{
	    case F_F: /* �ʼ����� (char. of an initial sound) */
		if (m != M_NULL || sp == 0)
		{
		    /* �ʼ��� ����ų� ���� ���� ������ ����
		...
		if ((t2 = comfcon3(f,t)) != 0)	/* ������ (double? consonant) */
		{
		    f=t2;
		    convert_3_to_code(f, M_NULL, L_NULL, buf);
		    push(buf);
		...
		if ((t2 = comcon3(l,t)) != 0)	/* �� ��ħ ?? (double prop?) */
		{
		    if (2 != convert_3_to_code(f, m, t2, buf))
			return AUTOMATA_ERROR;
	    ...
	    case F_A: /* Ư�����ڳ� ���� (special char. or number) */
		hangul_input_clear();
		*c = t;
		return AUTOMATA_SPECIAL;
	}
